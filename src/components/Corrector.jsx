...
const TEXTOS_IDIOMA = {
  ...
  chino:     { titulo: "写作纠正器", descripcion: "Escribi en chino y la IA te corrige.", placeholder: "用中文写点什么...", boton: "检查我的写作" },
  japones:   { titulo: "作文添削", descripcion: "Escribi en japones y la IA te corrige.", placeholder: "日本語で何か書いてください...", boton: "文章を確認する" },
  coreano:   { titulo: "글쓰기 교정기", descripcion: "Escribi en coreano y la IA te corrige.", placeholder: "한국어로 무언가를 써보세요...", boton: "내 글 확인하기" },
};
